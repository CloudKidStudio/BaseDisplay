...
(function(undefined){
	...
	/**
	*   BaseDisplay is a display plugin for the CloudKid Framework 
	...
	*/
	var BaseDisplay = function(id, options)
	{
		this.id = id;
		options = options || {};
		...
		/**
		*  The Animator class to use when using this display. BaseDisplay
	...
	*  BaseDisplay does not have a stage.
	*  @property {Object}
	*  @readOnly
	*  @public
	*  @default null
	...
	*/
	...
	namespace('cloudkid').BaseDisplay = BaseDisplay;
